...
INSERT INTO PUBLIC.users (email,password,role, name) VALUES ('email1@email.com', '$2a$10$0b2AErbUuyqDQ/Fw.P7Mz..dRa/cZlnWfzwCCsko8SSIs/qgMXGCa', 'ROLE_TEACHER', 'Name Name1');
INSERT INTO PUBLIC.users (email,password,role, name) VALUES ('email2@email.com', '$2a$10$0b2AErbUuyqDQ/Fw.P7Mz..dRa/cZlnWfzwCCsko8SSIs/qgMXGCa', 'ROLE_UNACTIVE', 'Name Name2');
INSERT INTO PUBLIC.users (email,password,role, name) VALUES ('email3@email.com', 'pass123', 'ROLE_UNACTIVE', 'Name Name3');
INSERT INTO PUBLIC.users (email,password,role, name) VALUES ('email4@email.com', 'pass123', 'ROLE_UNACTIVE', 'Name Name4');
INSERT INTO PUBLIC.users (email,password,role, name) VALUES ('admin@admin', '$2a$10$0b2AErbUuyqDQ/Fw.P7Mz..dRa/cZlnWfzwCCsko8SSIs/qgMXGCa', 'ROLE_ADMIN', 'Admin');
